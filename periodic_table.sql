...
--
-- Name: properties fk_propertis_elements; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_propertis_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
